...
class UserNames {
  ...
  final String propertyGetPhone = 'phone';
}
...
class User2Names {
  ...
  final String className = 'User2';

  final String constructorTestConstructor = 'testConstructor';

  final String fieldName = 'name';
  final String fieldEmail = 'email';
  final String fieldAddress = 'address';
  final String fieldBaseInfo = 'baseInfo';

  final String propertyGetPhone = 'phone';
  final String propertyGetNameof = 'nameof';
  final String propertyGetHashCode = 'hashCode';
  final String propertyGetRuntimeType = 'runtimeType';

  final String functionGetAge = 'getAge';
...
/// Container for names of elements belonging to the [InfoMixin] class
class InfoMixinNames {
  InfoMixinNames._();
